...
namespace
{
	...
	constexpr Container Corpus[] = {
		{"bare-16.container",
		 ...
		 139,
		 15584,
		 0xa002a2992df640feull,
		 3,
		 {{1, 146, 82180, 0x34eb7363dd3affc8ull},
		  {2, 82326, 29, 0xbfd0910bf8f1c63full},
		  {3, 82355, 25, 0x4a4c60d69390d998ull},
		  {0, 0, 0, 0}}},
		{"played-16.container",
		 85677,
		 2,
		 ...
		 159,
		 17824,
		 0x333beace65e0feaaull,
		 4,
		 {{1, 176, 85234, 0x261ab2c8943e064bull},
		  {2, 85410, 37, 0xbefe7c22e544cdd4ull},
		  {3, 85447, 25, 0xd4f214b467921044ull},
		  {4, 85472, 197, 0xa65b8a037dcc3b7aull}}},
		{"full-32.container",
		 200190,
		 2,
		 0,
		 ...
		 701,
		 78528,
		 0xa066899eaa656f2eull,
		 3,
		 {{1, 146, 199968, 0x050a7c2f4f8af71dull},
		  {2, 200114, 43, 0x40ed8c3bbb2a1640ull},
		  {3, 200157, 25, 0x0df7618587f8e774ull},
		  {0, 0, 0, 0}}},
		...
		// is the 24/25 rule Run.Checkpoint pins. It is played-16 as it was
		// BEFORE 18.10 too: the world without the climate, whose trailer the
		// row above no longer shares.
		{"host24-16.container",
		 80862,
		 2,
		 0,
	...
	// 18.02 MOVED BYTES AND NO WORLD; 18.10 MOVED THE WORLDS. The climate the
	// flip made the default changes every image (the trailers below, re-frozen
	// in the flip commit), and the HOST byte of the three reads 1. The kept
	// older container is the pre-climate played-16, so its trailer is the one
	// the whole corpus had before the flip - named here so that the day it
	// is regenerated by mistake, this line says so.
	static_assert(Corpus[0].Trailer == 0xa002a2992df640feull, "bare-16's image is not the climate world's");
	static_assert(Corpus[1].Trailer == 0x333beace65e0feaaull, "played-16's image is not the climate world's");
	static_assert(Corpus[2].Trailer == 0xa066899eaa656f2eull, "full-32's image is not the climate world's");
	static_assert(Corpus[3].Trailer == 0x64d11b40b612581cull,
				  "the kept older container is not the pre-climate played-16");
	static_assert(Corpus[3].Trailer != Corpus[1].Trailer, "the kept older container is the world of today's played-16");
