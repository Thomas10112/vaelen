...
namespace
{
	...
	constexpr IdKind AllKinds[] = {
		IdKind::None,		  IdKind::Entity,	IdKind::Event,			 IdKind::Region,
		IdKind::Tile,		  IdKind::River,	IdKind::ResourceDeposit, IdKind::Culture,
		IdKind::Language,	  IdKind::Religion, IdKind::Person,			 IdKind::Family,
		IdKind::Organization, IdKind::Item,		IdKind::Building,		 IdKind::Settlement,
		IdKind::Market,		  IdKind::Route,	IdKind::Polity,			 IdKind::Law,
		IdKind::Army,		  IdKind::War,		IdKind::Document,		 IdKind::Map,
		IdKind::MaxValue,
	};
