...
| `VaelenSim` | Kernel (UBT Runtime module, `PreDefault`; CMake static library), Phase 01 | SIMULATION (entities, components, systems, clock, events) | UBT: `Core`, `VaelenCore`. CMake: `Vaelen::Core`. | Phases 01-02 VALIDATED headless, 03.01-03.03 VALIDATED headless; UNVERIFIED under UBT |
