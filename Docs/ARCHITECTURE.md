...
| 07 POLITICS | `VaelenPolitics` | Kernel | Exists: the module, polities as entities founded on the councils of Phase 05, seated in a region, ruled by that council's head, holding regions that remember whose they are through every change of detail, dissolved when they rule nothing (07.01). Planned: law, authority and reach, succession, factions, diplomacy, politics in history, the gate (07.02-07.08). |
