...
| 06 ECONOMY | `VaelenEconomy` | Kernel | Exists: the module, goods as kinds, stocks held in common by every region and by the houses of a detailed region, endowed once from the land, split at a promotion, folded at a demotion, returned by an extinct house, conserved across the grains, moved by hand with a cause (06.01); the yearly harvest from the land, the people and their farming, cut by droughts, spoiled in store, eaten by house, the ration written for the need system, the deposits and the craft (06.02). Planned: markets and prices, trade and routes, wealth and inheritance, economy across the grains, economy in history, the gate (06.03-06.08). |
