...
| 01 CORE SIMULATION | `VaelenSim` | Kernel | Exists: entity handles and registry (01.01), component type registry, pools and store (01.02); tick, systems, event log, checkpoints, replay, simulation LOD 0-4 follow in 01.03-01.08. |
...
/
  ...
  Tests/
    ...
    Sim/Test_*.cpp                EntityHandle EntityRegistry ComponentType ComponentPool ComponentStore
  Tools/
