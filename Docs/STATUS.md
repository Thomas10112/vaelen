...
| 07.06-07.08 | Diplomacy, politics in history, the gate | PLANNED |
...
|---|---|---|---|---|---|---|---|---|
| linux-clang-debug | 0 warnings | 76/76 passed | 133 run, 133 passed, 22206 checks | 160 run, 160 passed | 36 run, 36 passed | 27 run, 27 passed | 26 run, 26 passed | 20 run, 20 passed |
| linux-gcc-debug | 0 warnings | 76/76 passed | 133 run, 133 passed, 22206 checks | 160 run, 160 passed | 36 run, 36 passed | 27 run, 27 passed | 26 run, 26 passed | 20 run, 20 passed |
| linux-clang-release | 0 warnings | 76/76 passed | 133 run, 133 passed, 22206 checks | 160 run, 160 passed | 36 run, 36 passed | 27 run, 27 passed | 26 run, 26 passed | 20 run, 20 passed |
| linux-gcc-release | 0 warnings | 76/76 passed | 133 run, 133 passed, 22206 checks | 160 run, 160 passed | 36 run, 36 passed | 27 run, 27 passed | 26 run, 26 passed | 20 run, 20 passed |
| linux-clang-noasserts | 0 warnings | 76/76 passed | 108 run, 108 passed, 21993 checks | 157 run, 157 passed | 36 run, 36 passed | 27 run, 27 passed | 26 run, 26 passed | 20 run, 20 passed |
| linux-gcc-noasserts | 0 warnings | 76/76 passed | 108 run, 108 passed, 21993 checks | 157 run, 157 passed | 36 run, 36 passed | 27 run, 27 passed | 26 run, 26 passed | 20 run, 20 passed |
