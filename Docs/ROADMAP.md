...
| 14 | UI | Interface and read-only views; command submission through the gameplay layer. | IN PROGRESS (14.01-14.04 done 2026-09-14; 14.05 next; the breakdown is section 20) |
...
`View.Life`, 4 tests, 305 checks, on a played 96-map through `Run::Aelvor`
...
unmoved. A neighbour is detailed the kernel's way - `RequestDetail` and the
