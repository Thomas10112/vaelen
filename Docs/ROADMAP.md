...
| 14 | UI | Interface and read-only views; command submission through the gameplay layer. | IN PROGRESS (14.01-14.08 written 2026-09-14, 14.08 awaiting the owner's UE build; 14.09 next; the breakdown is section 20) |
