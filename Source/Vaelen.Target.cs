...
public class VaelenTarget : TargetRules
{
	public VaelenTarget(TargetInfo Target) : base(Target)
	{
		...
		ExtraModuleNames.AddRange(new string[] { "VaelenCore", "VaelenSim", "VaelenPopulation", "VaelenSociety", "VaelenEconomy", "VaelenPolitics", "VaelenMilitary", "VaelenInfrastructure", "VaelenColony", "VaelenPlayer", "VaelenGameplay", "VaelenView", "VaelenRun", "VaelenGame", "Vaelen" });
	}
}
